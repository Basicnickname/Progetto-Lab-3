...
L'obiettivo dell'esperienza è studiare qualcosa di bellissimo, nello specifico:
\begin{itemize}
    \item Verificare che $1 + 1 = 2$.
    \item Finire le relazioni prima del 2030.
\end{itemize}
...
Elenco degli strumenti (se necessario con relative sensibilità o incertezze):
\begin{itemize}
    \item Cervello (Sensibilità: \SI{0}{\%})
    \item Cronometro digitale (Sensibilità: \SI{0.01}{s})
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Dati_1_Foglio1.png} 
    \caption{Grafico dei dati grezzi raccolti durante l'esperimento.}
    \label{fig:grafico_dati_grezzi}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Fit_1_Foglio1.png} 
    \caption{Grafico della Forza in funzione del conteggio di midichlorian.}
    \label{fig:grafico_fit}
\end{figure}
