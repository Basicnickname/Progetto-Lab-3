...
\begin{enumerate}[1.]
    \item Aprire VSCode e nella barra di ricerca in alto al centro digitare ">Preferences: Open User Settings (JSON)", aprire il file e copiarci all'interno il contenuto del file \href{URL}{text}
\end{enumerate}
\end{document}