...
Il file contiene le istruzioni per settare VSCode e Github per lavorare in \LaTeX.
Eventualmente possiamo organizzarci per setuppare anche Papeeria online.
...
Sempre nella cartella \textbf{src} trovate un video che mostra i passaggi principali per modificare i documenti e sincronizzarli con Github. \newline
\textbf{NB:} Nel caso lavorassimo contemporaneamente sullo stesso file potrebbero generarsi conflitti durante la sincronizzazione, se dovesse succedere dovremo correggerli manualmente.
...
\begin{enumerate}[1.]
    \item Aprire VSCode premere ctrl+shift+p e digitare Preferences: Open User Settings (JSON), aprire il file e copiarci all'interno il contenuto del file \href{https://github.com/Basicnickname/Progetto-Lab-3/blob/main/src/json}{json};
