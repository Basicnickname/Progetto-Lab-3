...
\begin{figure}[H]
    ...
    % Grafico 1 (Alto Sinistra)
    \begin{subfigure}[H]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{Fit_4_3a.png}
        \subcaption{Senza analizzatore.}
        \label{fig:3.1}
    \end{subfigure}
    \hfill % Spinge ai lati
    % Grafico 2 (Alto Destra)
    \begin{subfigure}[H]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{Grafico lamina lambda4 lineare.png}
        \subcaption{$\theta_{\lambda/4} = 0^\circ$ e $90^\circ$.}
        \label{fig:3.2}
    \end{subfigure}
            
    % Grafico 3 (Basso Sinistra)
    \begin{subfigure}[H]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{Fit_7_3c.png}
        \subcaption{$\theta_{\lambda/4} = 45^\circ$.}
        \label{fig:3.3}
    \end{subfigure}
    \hfill
    % Grafico 4 (Basso Destra)
    \begin{subfigure}[H]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{Grafico lamina lambda4 ellittico.png}
    ...
    \begin{subfigure}[H]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{Grafico_lamina_lambda4_polare.png}
