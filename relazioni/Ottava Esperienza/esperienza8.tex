...
\end{table}
\subsubsection{Studio della mutarotazione del glucosio}
Con i dati raccolti è stato eseguito un fit esponenziale con la formula tipica delle reazioni del primo ordine: $\alpha = (\alpha_0 - \alpha_{\infty}) \cdot \exp^{-kt} + \alpha_{\infty}$, dai parametri si sono ricavati i valori $k_0^{525}$ e $k_{\infty}^{525}$ per una soluzione di glucosio in luce verde.
