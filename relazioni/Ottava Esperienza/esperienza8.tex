...
36[\%] $\alpha$-D-glucosio e 64[\%] $\beta$-D-glucosio, i valori dell'angolo di rotazione variano seguendo una cinetica esponenziale (\autoref{fig:3}). Inoltre il valore misurato del potere rotatorio specifico all'equilibrio risulta coerente con quello tabulato (\autoref{tab:Potere rotatorio specifico mutarotazione}).
