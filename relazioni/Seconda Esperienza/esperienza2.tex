...
\section{Materiali e Metodi}
   ...
   \begin{itemize}
    ...
    \item \textbf LED
    \item \textbf Resistenze di carico ($R$): due resistenze da \qty{10}{\kilo\ohm} e \qty{20}{\kilo\ohm}
    \item \textbf Resistenza di protezione ($R_{LED}$) 
    \item \textbf due generatori d tensione 
    \item \textbf Multimetri digitali  
 \end{itemize}
...
\section{Analisi dei dati e grafici}
    \subsection{Tabelle risultati}
         Utilizzando le seguenti formule sono stati calcolati rispettivamente:
\begin{itemize}
...
\midrule
$\beta_1$    & 2.58e-03 & 6.14e-05 & 2.37e-02 \\
$\beta_2$    & 2.59e-03 & 7.06e-05 & 2.72e-02 \\
$I_{01}[mA]$    & 1.09e-09 & 1.90e-09 & 1.73e+00 \\
$n_1$        & 1.23     & 2.26e-01 & 1.82e-01 \\
$I_{02}[mA]$    & 2.58e-09 & 4.36e-09 & 1.69e+00 \\
$n_2$        & 1.28     & 2.35e-01 & 1.83e-01 \\
\bottomrule
\end{tabular}
\end{table}
...
I parametri $\beta$ sono più solidi e precisi ($err_{rel} \approx 2-3\%$), mentre i parametri $I_0$ e $n$ presentano incertezze maggiori.
 Il valore $n=1.2$ indica la presenza di fenomeni di ricombinazione non radiativa nella regione di svuotamento.
