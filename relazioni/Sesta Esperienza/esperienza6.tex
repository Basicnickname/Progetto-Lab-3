...
\begin{itemize}
    ...
    \item Laser verde e rosso %T: magari specificare la lunghezza d'onda esatta
    \item Metro (Sensibilità: \SI{0.01}{\meter}) %T: non credo serva specificare qua la sensibilità
    \item Generatore di funzione ? (o il generatore in continua) %T: abbastanza sicuro fosse Generatore di tensione continua
    \item Carta millimetrata
    \item Binario e supporti ottici
\end{itemize}

\subsection{Procedura sperimentale}
%T: secondo me qui scrivere esclusivamente la procedura sperimentale, le funzioni scriverle o prima delle tabelle risultati o nelle conclusioni
%   sottolineare che prima è stato fatto per la singola fenditura e poi per la doppia variando spessore e distanza tra le fenditure
%   far capire come si distinguono i minimi di diffrazione da quelli di interferenza
...
%T: anche qui prima tabelle e poi plot usando \subsubsection, per mettere tutti i dati unire i grafici che descrivono lo stesso fenomeno specificando bene la legenda per le differenze, circa le considerazioni estetiche come per la 5, mettere le lettere greche negli assi sarebbe figo
...
%T: i valori di errore sigma dai fit o errori assoluti?
...
%T: inglobarlo nelle altre esperienze, quindi scrivere l'obiettivo in alto e la procedura in fondo alle altre procedure, idem per tabelle e grafici
...
% -------------------------------------------------------------------
\section{Conclusioni}
%T: visto che in effetti non c'è molto da scrivere mettere qui le formule teoriche usate per fittate
%   potrebbe aiutare chiarire quali valori sono dovuti a diffrazione e quali ad interferenza 
