...
\subsection{Tabelle}
\subsection{Tabelle Risultati Fit caratterizzazione elettrica}
...
\subsection{Tabelle massimi caratterizzazione ottica}
...
\section{Conclusioni}
\textbf{Esiti fisici:}
Dai grafici della caratterizzazione elettrica si può osservare che i dati sperimentali seguono una curva esponenziale.
\\
\textbf{Commenti:}
Nei fit dei parametri l'errore relativo di $I_0$ è grande (perchè?)
