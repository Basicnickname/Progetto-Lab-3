...
Usando come funzione di fit $I = I_0(e^\frac{qV}{kT}-1)$ abbiamo ottenuto come valori di $I_0$:
\begin{table}[H]
    \centering
    \begin{tabular}{
        l 
        ...
        \midrule
        Giallo & 2.27e-33 & 9.61e-34 & 42.25 \\
        Rosso & 5.51e-30 & 3.64e-30 & 66.09 \\
        Blu & 2.85e-53 & 3.12e-53 & 109.53 \\
        Verde & 6.78e-54 & 8.05e-54 & 118.85 \\
        Bianco & 2.54e-49 & 2.10e-49 & 82.57 \\
        Infrarosso & 7.29e-23 & 1.93e-23 & 26.51 \\
        Fotodiodo & 1.98e-11 & 6.90e-12 & 34.91 \\
        \bottomrule
    \end{tabular}
...
I dati riportati in seguito sono la lunghezza d'onda e la relativa intensità massima per i LED di diverso colore: 
\begin{table}[H]
    \centering
    \begin{tabular}{
        l 
        ...
        \toprule
        {LED} & {Valore $\lambda$ [\unit{nm}]} & {Valore $V$ [\unit{mV}]} \\
        \midrule
        Giallo & 610 & 25.7 \\
        Rosso & 650 & 16.5 \\
        Blu & 470 & 132.1 \\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{E_gap-V_soglia.png}
