...
La simulazione Monte Carlo è stata effettuata con \texttt{C++} e ha permesso di stimare l'angolo solido sotteso dal rivelatore in modo più accurato.
Il flusso verticale sperimentale è risultato inferiore a quello teorico, ma nel complesso si ottiene un'efficienza di $\sim90\%$, abbastanza verosimile per il tipo di apparato utilizzato.
...
Inoltre, consultando anche \cite{shukla2018energyangulardistributionsatmospheric}, il valore $I_v$ fornito inizialmente potrebbe essere già riferito ai muoni con $"E>1$ \unit{GeV}" ed in quel caso la stima dell'assorbimento sarebbe superflua.   
