...
\begin{document}
    ...
    \section{Materiali e Metodi}
        ...
        \subsection{Procedura sperimentale}
            ...
            L'effetto è stato studiato variando il numero di fasci incidenti: impostandoli prima equistanziati (su 360°) e poi non equistanziati.
    ...
    \section{Dati sperimentali}
        ...
        \subsection{3 fasci equistanziati}
            \subsubsection{Fotoni}
                \begin{figure}[H]
                    \centering
        ...
        \subsection{3 fasci non equistanziati}
            \subsubsection{Fotoni}
                \begin{figure}[H]
                    \centering
        ...
        \subsection{4 fasci equistanziati}
            \subsubsection{Fotoni}
                \begin{figure}[H]
                    \centering
        ...
        \subsection{4 fasci non equistanziati}
            \subsubsection{Fotoni}
                \begin{figure}[H]
                    \centering
        ...
        \subsection{4 fasci equistanziati di protoni con diversa bixel width}
            \begin{figure}[H]
                \centering
        ...
        \subsection{3 fasci di protoni non equistanziati con scambio OAR-target}
            \begin{figure}[H]
                \centering
    ...
    \section{Conclusioni}
        ...
        Inoltre si può osservare come il caso con i fasci non equistanziati sia leggermente migliore rispetto a quello non equistanziato, poiché i fasci non sono costretti ad attraversare direttamente l'organo a rischio, ma sono tutti concentrati in direzione del target.
