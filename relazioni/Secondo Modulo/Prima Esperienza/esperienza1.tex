...
\begin{document}
    ...
    \section{Dati sperimentali}
        \subsection{Un fascio di particelle}
            \begin{itemize}
                \item \textbf{Fotoni}
                % Fotoni 1
                \begin{figure}[H]
        ...
        \subsection{Quattro fasci di particelle equistanziati}
            \begin{itemize}
                \item \textbf{Fotoni}
                 % Fotoni 4
                \begin{figure}[H]
        ...
        \subsection{Quattro fasci di particelle non equistanziati}
            \begin{itemize}
                \item \textbf{Fotoni}
                % Fotoni 4 no
                \begin{figure}[H]
        ...
        \subsection{Confronto quattro fasci di protoni con diversa bixel width}
            \begin{figure}[H]
                \centering
        ...
        \subsection{Confronto tre fasci di protoni con scambio OAR-target}
            \begin{figure}[H]
                \centering
