...
\begin{figure}[H]
     ...
     \begin{subfigure}[b]{0.45\textwidth}
         ...
         \subcaption{Confiugurazione di trasmissione.}
         \label{fig:1a}
     \end{subfigure}
     \begin{subfigure}[b]{0.45\textwidth}
         \centering
...
Dai dati di riflettanza del silico cristallino si ricava l'indice di rifrazione corrispondente a ciascuna lunghezza d'onda sfruttando la relazione:
\begin{equation}
